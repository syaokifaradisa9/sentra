...
export default function ProductEdit({
    ...
    const onCategoryChange = (event) => {
        ...
        const allowedBranchIds = categories
            .find((category) => category.id === numericValue)?.branches?.map((branch) => branch.id) ?? [];
                    ...
                    {product.photo_url && (
                        <div>
                            ...
                            <img
                                ...
                                alt={product.name}
                                className="object-cover w-48 h-48 rounded-lg border border-slate-200 dark:border-slate-700"
                            />
                        </div>
                    )}
